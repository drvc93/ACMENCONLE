...
/**
 * Created by drvc_ on 22/10/2016.
 */
public class ComprobarDeudaTask extends AsyncTask<String,String,String> {
    @Override
    protected String doInBackground(String... strings) {
        ...
        final String METHOD_NAME = "VerificarDeudaSocio";
        ...
        Log.i("retur value Comprobar deuda Task => ", result);
        return result;
    }
}
